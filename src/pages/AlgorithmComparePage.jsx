...
const AlgorithmComparePage = ({ onNavigate }) => {
  ...
  const addAlgorithm = (algorithmId) => {
    if (
      ...
      !selectedAlgorithms.includes(algorithmId)
    ) {
              ...
              <table className="w-full">
                  ...
                  <tr>
                    ...
                    {selectedAlgorithms.map((algorithmId) => {
                      ...
                      return (
                        <th
                          key={algorithmId}
                          className="px-6 py-4 text-left text-sm font-medium text-gray-900 relative"
                        >
                          <div className="flex items-center justify-between">
                ...
                <tbody className="divide-y divide-gray-200">
                      ...
                      return (
                        ...
                        >
                          ...
                          {algorithm.category === "searching" &&
                            "探索アルゴリズム"}
                          {algorithm.category === "data-structures" &&
                            "データ構造"}
                    ...
                    {selectedAlgorithms.map((algorithmId) => {
                      ...
                      return (
                        <td key={algorithmId} className="px-6 py-4">
                          <span
                            className={`px-3 py-1 rounded-lg text-sm font-medium ${getComplexityColor(
                              complexity
                            )}`}
                          >
                            {complexity}
                  ...
                  {selectedAlgorithms.some(
                    (id) => algorithms[id].stable !== undefined
                  ) && (
                    <tr>
                      <td className="px-6 py-4 text-sm font-medium text-gray-900">
                        安定ソート
                  ...
                  {/* インプレース */}
                  {selectedAlgorithms.some(
                    (id) => algorithms[id].inPlace !== undefined
                  ) && (
                    <tr>
                      <td className="px-6 py-4 text-sm font-medium text-gray-900">
                        インプレース
